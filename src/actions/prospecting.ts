...
function mapToVertical(types: string[]): BusinessVertical {
  const typeMap: Record<string, BusinessVertical> = {
    ...
    hair_salon: "HAIR_SALON_BARBERSHOP",
    beauty_salon: "HAIR_SALON_BARBERSHOP",
    barber_shop: "HAIR_SALON_BARBERSHOP",
    spa: "DAY_SPA_MASSAGE",
    dentist: "DENTAL",
    physiotherapist: "PHYSICAL_THERAPY",
    chiropractor: "CHIROPRACTIC",
    veterinary_care: "VETERINARIAN",
    pet_store: "PET_GROOMING",
    lawyer: "LEGAL",
    accountant: "ACCOUNTING",
    insurance_agency: "INSURANCE",
    real_estate_agency: "REAL_ESTATE",
    restaurant: "RESTAURANT",
    gym: "PERSONAL_TRAINERS",
    yoga_studio: "YOGA",
    dance_studio: "DANCE_STUDIOS",
    photographer: "PHOTOGRAPHY",
    tattoo_parlor: "TATTOO_PIERCING",
    nail_salon: "NAIL_SALON",
    landscaping: "LANDSCAPING_LAWN",
    cleaning_service: "HOUSE_CLEANING",
  };
